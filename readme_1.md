...
- Testable: The core of the application must be testable with no impact of dependencies. The quality must be ensured right from the moment any of the outer layers are not working yet.
